...
class Bookcase extends Component {
  ...
  // props = {
  //   bookIDsCurrentlyReading: ['nggnmAEACAAJ', 'sJf1vQAACAAJ'],
  //   bookIDsWantToRead: ['evuwdDLfAyYC', '74XNzF_al3MC'],
  //   bookIDsRead: ['jAUODAAAQBAJ', 'IOejDAAAQBAJ', '1wy49i-gQjIC'],
  // }
        ...
        <div className="list-books-content">
          <div>
            <Bookshelf
              ...
              books={this.state.booksCurrentlyReading}
            />
